...
hanleClick(btnAdd,addview,overlay,'active')
hanleClick(btnClose,addview,overlay,'active','remove')
hanleClick(overlay,addview,overlay,'active','remove')
hanleClick(btnCancel,addview,overlay,'active','remove')
