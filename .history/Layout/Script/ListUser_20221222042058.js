...
$('.item-active').onclick = (e) => {
    $('.item-active .menu-item-sub').classList.toggle('menu_sub-toggle');
}
...
//         console.log(getXY(e.target).top);
//         $('.nav-active').style.top=`${Math.abs(navActiveP-getXY(e.target).top)}px`;
//     }
// }
// Page DashBoard
// Page List User
