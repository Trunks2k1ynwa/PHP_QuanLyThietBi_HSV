...
$('item-active').children[1].classList.remove('hidden');
for (const menuItem of menuNav) {
    menuItem.onclick = (e)=>{
        ...
        if(menuItemActive.classList.contains('hidden')){
            menuItemActive.classList.remove('hidden');
        }else{menuItemActive.classList.add('hidden')}
